      ...
      <div className="border-b-2 border-gray-400 py-4">
        ...
        {!isIOS && <div className="text-gray-600 text-center mx-auto mt-1 text-sm">
          ...
          <Switch
            ...
            className={clsx(
              convoState.value.audio.shouldAutoPlay ? 'bg-factgpt-primary' : 'bg-gray-200',
          ...
          <Disclosure key={section.title} defaultOpen={!section.defaultHide}>
            {({ open }) => (
              <div className="mx-auto w-full rounded-2xl bg-white py-1">
                <Disclosure.Button className="flex w-full justify-between rounded-lg bg-gray-200 px-4 py-2 text-left text-sm font-medium text-factgpt-secondary hover:bg-gray-300 focus:outline-none focus-visible:ring focus-visible:ring-opacity-75">
